...
namespace eBus.WebAPI.Migrations
{
    ...
    partial class eBusContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("eBus.WebAPI.Database.Kartum", b =>
                {
                    ...
                    b.HasOne("eBus.WebAPI.Database.VrstaKarte", "VrstaKarte")
                        .WithMany("Karta")
